  ...
  return (
    <main>
      <section className="grid grid-cols-1 md:grid-cols-2 md:px-32 mx-auto  ">
        <div className="bg-[#6a6044] md:w-[400px] md:h-[590px] p-9 md:my-20  text-black font flex flex-col space-y-5 items-center justify-center ">
          <h1 className="text-5xl text-[#6a6044] bg-[#d1cccc]">SERVICES</h1>
          <Image src={"/RAYS (8).png"} width={500} height={500} alt="" />
          <h3 className="text-white md:text-2xl text-xl font">
            Turn your Dreams into Reality
          </h3>
          <Link href={"/contact"}>
            <Button className="md:px-24 px-20 py-5 md:py-7 bg-[#c0a249] text-white  hover:bg-white hover:text-[#c0a249] font text-2xl">
              For Queries
            </Button>
          </Link>
        </div>
      ...
      <section className="md:mt-3 mt-9">
        <h1 className=" text-3xl md:text-5xl font-thin flex flex-col ml-16 md:ml-0 md:text-center md:mb-9 text-[#c0a249]">
          T E S T I M O N A L S
        </h1>
        <Carousel className="md:p-5 my-3 mx-20 md:mx-48">
          <CarouselContent>
            <CarouselItem>
              <h1 className="md:text-9xl text-white md:text-black  font-serif  mt-3 md:mt-0 md:ml-[390px]">
                &quot;
              </h1>
              <div className="flex flex-col text-center mt-5 items-center font">
                <h1 className="md:text-5xl text-3xl md:my-5">
                  Exceptional service!{" "}
                </h1>
                <h1 className="md:text-5xl text-3xl">
                  Made our event unforgettable.
                </h1>
                <h1 className="md:text-5xl text-3xl md:my-5">
                  Highly recommend them!
                </h1>
                <h3 className="md:text-2xl text-xl  text-[#c0a249] my-9">
                  Sarah Miller
                </h3>
              </div>
            </CarouselItem>
            ...
            <CarouselItem>
              ...
              <div className="flex flex-col text-center items-center font">
                <h1 className="md:text-5xl text-3xl md:my-5 mt-5 ">
                  Amazing attention to detail!
                </h1>
                <h1 className="md:text-5xl text-3xl  ">
                  They turned our vision into reality{" "}
                </h1>
            ...
            <CarouselItem>
              ...
              <div className="flex flex-col text-center items-center font">
                <h1 className="md:text-5xl text-3xl md:my-5 mt-5">
                  Professional, creative, and organized.{" "}
                </h1>
                <h1 className="md:text-5xl text-3xl">
