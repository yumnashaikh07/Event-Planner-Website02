...
//     // Prepare the email data to send through Email.js
...
//         alert("Your booking has been confirmed!");
//         window.location.href = "/thankyoupage"; // Redirect to a thank-you page after successful submission
//       } else {
//         alert("There was an error with your booking. Please try again.");
//       }
//     } catch (error) {
...
//       <h2 className="text-5xl font-extralight text-center text-[#c0a249] mb-6">Booking Form</h2>
